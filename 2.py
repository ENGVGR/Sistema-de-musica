...
def deletar(musica):
    ...
    if musica in lista_de_musicas:
        if play and musica != musica_tocando:
            posicao = lista_de_musicas.index(musica)
...
def next(musica):
    ...
    if musica in lista_de_musicas:
        if play and musica != musica_tocando:
            primeira_ocorrencia = (lista_de_musicas.index(musica))
            memoria_acoes.append('next')
            posicao_antes_do_next.append(primeira_ocorrencia)
            posicao_pos_next.append(lista_de_musicas.index(musica_tocando) + 1)
            
            lista_de_musicas.pop(primeira_ocorrencia)
            lista_de_musicas.insert(lista_de_musicas.index(musica_tocando) + 1,musica)
            
            
        elif not play and musica_tocando == '':
            memoria_acoes.append('next')
            ...
            lista_de_musicas.pop(primeira_ocorrencia)
            lista_de_musicas.insert(lista_de_musicas.index(musica_tocando),musica)
            
            musica_tocando = musica
...
def status():
    global musica_tocando
    global index_musica_tocando
    
    if len(lista_de_musicas) > 0 and musica_tocando == '':
        print(lista_de_musicas[0])
    elif musica_tocando != '' and len(lista_de_musicas) > 0:
        if musica_tocando in lista_de_musicas:
            print(musica_tocando)
        else:
            if int(index_musica_tocando) == int(len(lista_de_musicas)):
                musica_tocando = ''
                print(lista_de_musicas[0])
            else:
                musica_tocando = ''
                print(lista_de_musicas[index_musica_tocando])
                index_musica_tocando = 0
    else:
...
def terminar():
    ...
    if play and len(lista_de_musicas) > 0:
        atual = lista_de_musicas.index(musica_tocando)
        if atual < len(lista_de_musicas) - 1:
            musica_tocando = lista_de_musicas[atual+1]
        else:
            musica_tocando = lista_de_musicas[0]
            
        index_musica_tocando = lista_de_musicas.index(musica_tocando)
